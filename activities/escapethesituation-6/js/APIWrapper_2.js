/*******************************************************************************
**
** FileName: APIWrapper_2.js
** 
** Modified 2.2010 by JB. doLMSSetValue() modified to return success/failure
** data after setting SCORM element to API. Flash class SCORMCom (version 2)
** requires this modification for proper feedback and error handling.
**
*******************************************************************************/
...
**
*******************************************************************************/
/*function doLMSSetValue(name, value) // Original version
{
   var api = getAPIHandle();
   if (api == null)
   {
...
function doLMSSetValue(name, value) // Modified 2.26.2010 by JB to return "true" if successful or error string.
{
   var api = getAPIHandle();
   if (api == null)
   {
